...
(function () {
   ...
   *  сите на Google. Клиентот побара да изгледа ИСТО како картичките со
   *  рецензии (иста класа `.quote`, иста големина, иста боја), само со свој
   *  текст и копче наместо цитат — затоа е последно во низата, што значи
   *  најдесно во мрежата од четири (види grid-template-columns во
   *  css/theme-v2.css). Ако нема линк (reviewsLink е празен), полето
   *  воопшто не се прикажува — копче што никаде не води е полошо од копче
   *  што го нема. */
