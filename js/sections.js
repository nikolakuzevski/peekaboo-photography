...
(function () {
  ...
  /* ---------------------------------------------------------------------------
     ...
     Слајдерот е „гол": гола слика без лента (нема стрелки, точки, копче
     „Пауза", ни црн градиент). Целата слика е кликлива и оди на следната;
     сама се менува на секои 3с ако никој не ја допира. Автоматското менување
     паузира додека покажувачот или тастатурниот фокус е врз сликата (тоа е
     механизмот за сопирање наместо копчето), и не се пали ако прелистувачот
     бара помалку движење. Тастатура: слајдерот е фокусибилен, Enter/Space оди
     на следната.
     ------------------------------------------------------------------------ */
