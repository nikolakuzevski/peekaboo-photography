/* =============================================================================
   ...
   -----------------------------------------------------------------------------
   Сѐ се црта од content/site-data.js. Празна низа не е дупка во дизајнот —
...
(function () {
  ...
  function init() {
    ...
    function render() {
      ...
      if (!items.length) {
        ...
        announce(active === 'site'
          ? 'Галеријата сѐ уште нема фотографии.'
    ...
    function buildChips() {
      ...
      // Ако сѐ уште нема ниту една слика, филтерот нема што да филтрира.
